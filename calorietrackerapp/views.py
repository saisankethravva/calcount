...
def weightlog(request):
    ...
    # Retrieve the weight logs ordered by entry_date in ascending order
    userweightlog = UserWeight.objects.filter(user_name=request.user).order_by('entry_date')
